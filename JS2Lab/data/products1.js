const products1 = [
    ...
    },
    {
        id: "4",
        author: "Sandra Wu",
        bookname: "Java 重構- Java Refactoring",
        category_sid: "1",
        book_id: "PG20252",
        publish_date: "2010-01-21",
        pages: 432,
        price: 490,
        isbn: "978-986-201-087-7 ",
        on_sale: "1",
        introduction:
    ...
    },
    {
        id: "5",
        author: "Julian",
        bookname: "Linux Device Driver Programming 驅動程式設計",
        category_sid: "1",
        book_id: "PG20280",
        publish_date: "2009-01-05",
        pages: 624,
        price: 690,
        isbn: "978-986-201-186-7 ",
        on_sale: "1",
        introduction:
            "本書是一本寫給Linux裝置驅動程式開發者的書籍。以初次開發裝置驅動程式的開發者也容易理解的角度，從基礎概念開始詳加解說。\r\n\r\n全書前半部以著重於裝置驅動程式開發前的基本知識及其思考方法做為主要介紹，在後半部則依每個不同的硬體做專章的探討。網羅從計時器、記憶體、中斷的基礎到 PCI Express、ACPI、IPMI等最新的硬體知識。除此之外，還包含執行手法、偵錯手法、同步與鎖定…等等主題，一直到解讀既有驅動程式碼的技巧，全都收錄在本書中。\r\n\r\n本書獲得日本Amazon讀者票選五顆星的青睞，書中隨附光碟內更收錄了書中範例程式碼。不管對入門者或是專業的 Linux程式設計師來說，本書內所提及的開發驅動程式的精華，絕對會讓您很快就成為驅動程式的開發戰力。 ",
    },
    {
        id: "6",
        author: "Arron",
        bookname: "Excel VBA 2007程式設計 - 增訂新版",
        category_sid: "1",
        book_id: "PG20271",
        publish_date: "2008-05-27",
        pages: 400,
        price: 450,
        isbn: "978-986-201-129-4",
        on_sale: "1",
        introduction:
            "本書的設計主軸，即是以企業人員目前所面臨到的資料應用為課題，以深入淺出的方式，利用最簡單的VBA語言工具，快速而有效率的處理在企業中所會面臨到的會計帳務處理、行銷問卷整合、業務經銷資料佣金計算或者是行政人員所面臨的人事出缺席計算等課題，用既有的活頁簿資料，輔以VBA程式，快速的計算出帳務資料、經銷佣金或出缺席資料…等問題。\r\n\r\n透過本書，讀者可以深入學習Excel最經典的部份，經由深入淺出的說明，引導讀者一步步熟悉 VBA在Excel中的應用，為讀者建立VBA程式設計的基礎；搭配豐富的圖文解說，導引學習並熟悉VBA語法及架構，教讀者對問題迎刃而解的最佳法則！",
    },
    {
        id: "7",
        author: "姜姃延",
        bookname: "彩繪天堂Painter數位插畫輕鬆學",
        category_sid: "2",
        book_id: "GH20187",
        publish_date: "2009-09-14",
        pages: 448,
        price: 550,
        isbn: "978-986-201-255-0",
        on_sale: "1",
        introduction:
    ...
    },
    {
        id: "8",
        author: "金惠京",
        bookname: "不一樣的創作設計風格- Photoshop Artworks Stylebook ",
        category_sid: "2",
        book_id: "GH20200",
        publish_date: "2009-11-30",
        pages: 304,
        price: 520,
        isbn: "978-986-201-276-5",
        on_sale: "1",
        introduction:
